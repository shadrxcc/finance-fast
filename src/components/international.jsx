    ...
    <div className="flex flex-col gap-y-[88px]">
      ...
      <div className="flex flex-col p-[1em] gap-[5em] md:flex-row items-center justify-evenly">
        ...
        <div className="feature-vs_divider gap-1 items-center flex md:flex-col">
          <div
            data-aos="fade-down"
            className="line md:min-w-[1px] min-h-1px min-w-[135px] md:min-h-[225px] border border-solid border-bgrey"
          ></div>
          <div
            data-aos="zoom-in"
            className="text-block-4 text-lg leading-6 font-bold text-[#3A3A3A]"
          >
            VS
          </div>
          <div
